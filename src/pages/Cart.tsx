...
export const Cart = () => {
  ...
  return (
    <section className="h-screen bg-gray-100 py-12 sm:py-16 lg:py-20 flex items-center">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 ">
        ...
        <div className="mt-8 md:mt-12">
          <div className="rounded-md bg-white shadow w-[900px] ">
            <div className="px-4 py-6 sm:px-8 sm:py-10">
                    ...
                    <div className="relative flex flex-1 flex-col justify-between">
                      <div className="sm:col-gap-5 sm:grid sm:grid-cols-2">
                        <div className="pr-8 sm:pr-5">
                          ...
                          <p className="mx-0 mt-1 mb-0 text-sm text-gray-400">200g</p>
                        </div>
              ...
              <div className="mt-6 border-t border-b py-2">
                <div className="flex items-center justify-between">
                  ...
                  <p className="text-lg font-semibold text-gray-900">400.00 ฿</p>
                </div>
                <div className="flex items-center justify-between">
